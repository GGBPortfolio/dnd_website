...
const artSentences = ["This hunk of a fairy is Aungus McLeoud (played by Declan Riordan)", "This green tiefling is Mordos Shadowstrike (played by Jake Skubish)", "This half-elf dealer is Timble Von Trimble (played by Timmy Huddle)", "This dirty, mountain-man is Zellicek Krall (played by Mark Hallman)", "This terrifying bird person is Veyron DeFalco (played by Gordon Brinkman)", "ROUGH DRAFT of the map of Elustria with regional faction borders drawn", "Map of the city of Barronia, capital of Elustria", "Faction map of Barronia", "This is the job board loacated in the city of Circos", "This is the job board loacated in the city of Barronia", "(UNUSED) This is the job board loacated in the city of Palomeras", "ROUGH DRAFT of magical stone the party stole off of Olburr Sootfoot. Unbeknownst to them, many parties were seeking this magical artifact", "Magical earrings the party found looting the shipwreck of the roken Bridge Pirates", "Mermaid armor the party found looting the shipwreck of the roken Bridge Pirates", "Magical conch shell the party found looting the shipwreck of the roken Bridge Pirates. The infamous source of Bubbbly Bob", "A magical war axe gifted to Semaj Yak after defeating a Druid Samurai's spirit", "The cursed sword the party found looting the shipwreck of the roken Bridge Pirates AKA Hack Sparrow's demise", "These are the crests of the Lords of the Royal Court (in order from right to left, top then bottom): Lord Brozzerious of Marble City, Lord Gavyn of Palomeras, Lord Einar of Avilon, Lord Izyr of Magothica, Lord Zurvan of Circos, Lord Joobie of Adelean, and Lady Ylbeth of Heartholm", "These are the crests of the Old Houses of Elustria (in order from right to left, top then bottom): The Wapoo Clan, the Farfalleon Shogunate, The Imperiamotto Shogunate, the Shilu Shogunate, the Tantakhan Clan, and the Enya Clan", "Mural 1 of Cercie's Temple (translation): The heroic union of the Kigimori and Kyojin sealing away the Akuma and Ryutatsu. The first three led the charge and . . .", "Mural 2 of Cercie's Temple (translation): Guilpharess, Nysoru, and Callitris; Their essence passed down to one and all so that their work may continue. Their spirits, eternal, their power. . .", "Mural 3 of Cercie's Temple (translation): Cercie and Ilgalore fought valiantly against their vengeful third, Igris the Wise, who… ", "Mural 4 of Cercie's Temple (translation): Cercie the Bountiful, the eldest of her time’s chosen, nurtured the lands of those in need.", 
                        "Poster of Mr. Queen's newest theatrical debut about the Mad Druid King", "Melville Barrett's Wanted Poster released to the public after the coronation of the new king", "Palomeras' recruitment poster for The Pearl Legion", "Palomeras' recruitment poster for The Elustrian Navy", "Palomeras' propaganda poster warning any farmers thinking of joining The Scythborne"]
